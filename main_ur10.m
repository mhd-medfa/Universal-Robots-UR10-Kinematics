...
link_lengths = [0.128, 0.6127, 0.5716, 0.1639, 0.1157, 0.0922];

%% Testing Weighted Pseudo Inverse IK function
p_des=[0.1 , 0.1 ,1 , 0 ,0 ,0]';
q_start=[0,0,0,0,0,0]';
weights=diag([10 80 50 30 30 1]);
...
%     q_square_path=Task_Priority_Correct(q_start ,weights, p_goal , link_lengths, 100);
%     Q(i,:)=q_square_path';
%         
% end
